...
var enableAutoAddChar;

/* Add when implemented button correctly.
chrome.runtime.sendMessage({want: "enableAutoAddChar"}, function(response) {
	enableAutoAddChar = response.enableAutoAddChar;
	
});

alert(enableAutoAddChar);
*/
